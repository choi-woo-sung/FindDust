...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public HiltGradleLibraryAccessors getGradle() { return laccForHiltGradleLibraryAccessors; }
    ...
    public static class HiltGradleLibraryAccessors extends SubDependencyFactory {
        ...
        public HiltGradleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPlugin() { return create("hilt.gradle.plugin"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidxComposeUi (1.3.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxRoom (2.4.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: benManes (0.41.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getBenManes() { return getVersion("benManes"); }
            ...
            /**
             * Returns the version associated to this alias: updatePlugin (0.7.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getUpdatePlugin() { return getVersion("updatePlugin"); }
    ...
    public static class PluginAccessors extends PluginFactory {
         ...
         */
        public DependencyPluginAccessors getDependency() { return paccForDependencyPluginAccessors; }
    ...
    public static class DependencyPluginAccessors extends PluginFactory {
        ...
        public DependencyPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for dependency.catalog to the plugin id 'nl.littlerobots.version-catalog-update'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCatalog() { return createPlugin("dependency.catalog"); }

            /**
             * Creates a plugin provider for dependency.update to the plugin id 'com.github.ben-manes.versions'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getUpdate() { return createPlugin("dependency.update"); }
